...
export class ServiceService {
 ...
 events= [
  ...
  },
  {
    ...
    'details': 'Bazinga is looking for innovative ideas. It is a part of a series of competitions hosted by YUGMA 2021 . The competition is open to all students with ideas related to Engineering products and Businesses. \<br><br>\ Problem statement : Design a product which can aid humanity during natural disasters. \<br><br>\ In the 20 years between 2000-2019, more than 1.5 million people died and more than 4 billion people were affected by disasters. We cannot stop natural disasters but we can arm ourselves with knowledge: so many lives wouldn\'t have to be lost if there was enough disaster preparedness. Let this be a stage to ignite your innovative thoughts and save lives. \<span class="high">\ Rules and Regulations : \</span>\ \<br><br>\ Requirements: \<br><br>\ \<ul>\ \<li>\Students may register as a team of two or as an individual.\</li>\ \<li>\Team members must be involved in all aspects of the pitching competition. \</li>\ \<li>\The team must show a balancing of skills in Engineering and other relevant areas.\</li>\ \</ul>\ \<br><br>\ Guidelines : \<br><br>\ \<ul>\ \<li>\Students have to send the abstracts before the deadline. \<\li>\ \<li>\Top ideas will be shortlisted by the judges. \<\li>\ \<li>\Selected students have to provide detailed PPT presentations. \<\li>\ \<li>\ Scores from both the abstract and the presentation will be taken into account for the final scores \<\li>\ \<li>\ Top scorers will be awarded.\<\li>\ \</ul>\  \<br><br>\ Venue : Google meet \<br><br>\ Prize : 4.5k worth prizes 🎁 \<br><br>\ ☎️ For queries : \<br>\ 📞 Aaron - 6235412348 📞 Alfiya - 9074717001',
    'register': true,
    'active': true
  }  ,
  {
