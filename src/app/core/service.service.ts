...
export class ServiceService {
 ...
 events= [
  ...
  },
  {
    ...
    'url': 'humoursapien',
    'subtitle': '',
    'img': 'https://res.cloudinary.com/www-santhoshthomas-xyz/image/upload/v1623078410/asme/arabica-927_a7z6zg.png',
    'day': '13',
    'time': 'June | 6.00 PM - 7.30 PM',
    'short': 'Stand up comedy competition',
    'details': 'Comedy, we may say, is society protecting itself - with a smile - J B Priestley \<br><br>\ These are tough times for all of us here, longing to be back in college, missing friends and our loud laughters.\<br><br>\ Though the situation ain’t gonna change so soon, yet we thought of doing a bit.\<br><br>\ YUGMA 2021 brings you an opportunity to develop creativity and sense of humour to identify that terrific Chandler Bing in you through  ‘ HUMOUR SAPIENS ’ - an online stand up comedy competition on the topic "COLLEGE LIFE" : \<br><br>\ Let this be your chance to unleash the Sarcastic Beast in you.\<br><br>\ So gear up, grab your funny tongues and join us in the most awaited hysterical competition from YUGMA2021.\<br><br>\ \<span class="high">\ GUIDELINES \</span>\ \<br><br>\ Participants should upload the video along with the registration. \<br>\ \<ul>\ \<li>\⭕ Time limit-  2 to 5 mins\</li>\ \<li>\⭕ Video limit- 50 MB\</li>\ \<li>\⭕ Your material must be original, if found to be copied from another comic you will be disqualified from the event.\</li>\ \<li>\⭕ Editing is not allowed\</li>\ \</ul>\ \<br><br>\ Cheers to more guffawing & entertainment !\<br><br>\ \<span class="main">\ Registration closes on June 17. \</span>\ ',
    'register': true,
  ...
  },
  {
    ...
    'url': 'talksession2',
    'short': '',
    'img': 'https://res.cloudinary.com/www-santhoshthomas-xyz/image/upload/v1623062800/asme/Music_festival-cuate_sddemu.png',
    'day': '18',
    'time': 'June | 7.00 PM - 7.30 PM',
    'details': '',
    'register': true,
